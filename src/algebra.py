...
class FHRR:
    ...
    @staticmethod
    def bundle(a: NDArray[cp.complex64], b: NDArray[cp.complex64]) -> NDArray[cp.complex64]:
        """
    ...
    @staticmethod
    def bundles(vectors: NDArray[cp.complex64]) -> NDArray[cp.complex64]:
    ...
    @staticmethod
    def bind(a: NDArray[cp.complex64], b: NDArray[cp.complex64]) -> NDArray[cp.complex64]:
        """
    ...
    @staticmethod
    def binds(vectors: NDArray[cp.complex64]) -> NDArray[cp.complex64]:
    ...
    @staticmethod
    def invert(a: NDArray[cp.complex64]) -> NDArray[cp.complex64]:
        """
    ...
    @staticmethod
    def unbind(a: NDArray[cp.complex64], b: NDArray[cp.complex64]) -> NDArray[cp.complex64]:
        """
    ...
    @staticmethod
    def cosine_similarity(a: NDArray[cp.complex64], b: NDArray[cp.complex64]) -> float:
        """
